        ...
        <div className="Team_card ">
          ...
          <div className="Team_card-body ">
            ...
            <a
              ...
              rel="noreferrer"
            >
              <button className="Team_btn" ><i className="ri-github-fill"></i></button>
            </a>
            <a
              href={url2 ? url2 : "#!"}
              target="_blank"
              ...
              rel="noreferrer"
            >
              <button className="Team_btn" ><i className="ri-linkedin-box-fill"></i></button>
            </a>
            <a
              href={url3 ? url3 : "#!"}
              target="_blank"
              ...
              rel="noreferrer"
            >
              <button className="Team_btn" ><i className="ri-twitter-fill"></i></button>
            </a>
            </div>
          </div>
        </div>
